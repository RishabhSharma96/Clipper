...
import clipperLogo from "../../public/clippernoback.png"
const Signin = () => {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <motion.div
                    className="bg-white shadow lg:w-1/3  md:w-1/2 w-full p-10 mt-16 text-center rounded-md border-t-4  border-b-4  border-t-pink-500 border-b-pink-500 "
                    initial={{ opacity: 0, y: '200vh' }}
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: '200vh' }}
                    transition={{ duration: 1.2, delay: 0.4 }}
