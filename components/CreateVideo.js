...
const CreateVideo = () => {
        ...
        if (checker) {
            ...
            if (topic === "Other") {
                ...
                if (tagCheck) {
                    ...
                    setTagError("Add a # Tag To your Custom Topic");
                }
            } else {
                setTagShow(false);
                setHashTags("#");
    ...
    return (
        <div className="flex w-full h-full  relative left-0 top-[60px] lg:top-[70px] mb-10 pt-2 lg:pt-0 justify-center "
            ...
            >
                <div>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center  outline-none mt-10 w-[400px] h-[400px] pl-10 pr-10 cursor-pointer hover:border-red-300 hover:bg-gray-100">
                        {loading ? (
                            <>
                                <UploadeSkeleton />
