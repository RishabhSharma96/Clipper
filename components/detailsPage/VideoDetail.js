                        ...
                        <div className="lg:mt-20 mt-10">
                            ...
                            />
                                            ...
                                            <div className="mb-4 flex items-center justify-end cursor-pointer">
                                                <motion.div
                                                    whileHover={{ scale: 1.1 }}
                                                    whileTap={{ scale: 0.9 }}
                                                // classsName="bg-pink-500 rounded-full px-2 py-2"
                                                >
                                                    {/* <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                          ...
                          >
                            <path d="M3.478 2.405a.75.75 0 00-.926.94l2.432 7.905H13.5a.75.75 0 010 1.5H4.984l-2.432 7.905a.75.75 0 00.926.94 60.519 60.519 0 0018.445-8.986.75.75 0 000-1.218A60.517 60.517 0 003.478 2.405z" />
                                                    ...
                                                    <TelegramShareButton url={videoLink}>
                                            ...
                                            <div className="mb-4 flex items-center justify-end cursor-pointer">
                                                ...
                                                >
                                                    {/* <AiOutlineTwitter className="text-white text-[18px]" /> */}<TwitterShareButton url={videoLink}>
